...
from src.official.transformer.model import beam_search as v1
...
class SequenceBeamSearchV2(v1.SequenceBeamSearch):
  ...
  def search(self, initial_ids, initial_cache):
    ...
    import sys
    finished_seq = tf.pad(finished_seq, paddings=[[0,  0], [0,  0], [0, 200-tf.shape(finished_seq)[-1]]], constant_values=0)
