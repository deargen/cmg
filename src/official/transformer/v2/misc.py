...
from src.official.transformer.model import model_params
from src.official.utils.flags import core as flags_core
from src.official.utils.misc import keras_utils
...
PARAMS_MAP = {
    ...
    'optgen_v1_multi': model_params.OPTGEN_V1_MULTI_PARAMS,
    'optgen_v2_multi': model_params.OPTGEN_V2_MULTI_PARAMS,
    'optgen_tiny': model_params.OPTGEN_TINY_PARAMS,
    'optgen_v1': model_params.OPTGEN_V1_PARAMS,
    'optgen_v2': model_params.OPTGEN_V2_PARAMS,
    'optgen_v3': model_params.OPTGEN_V3_PARAMS,
    'optgen_v4': model_params.OPTGEN_V4_PARAMS,
    'optgen_v5': model_params.OPTGEN_V5_PARAMS,
    'optgen_v6': model_params.OPTGEN_V6_PARAMS,
    'optgen_v7': model_params.OPTGEN_V7_PARAMS,
    'optgen_v8': model_params.OPTGEN_V8_PARAMS,
    'optgen_v9': model_params.OPTGEN_V9_PARAMS,
    'optgen_v10': model_params.OPTGEN_V10_PARAMS,
    'optgen': model_params.OPTGEN_PARAMS
...
def get_model_params(param_set, num_gpus):
    ...
    if num_gpus > 1:
        ...
        elif param_set.endswith('_multi'):
            return PARAMS_MAP[param_set].copy()
        else:
            PARAMS_MAP[param_set].copy()
...
def define_transformer_flags():
    ...
    flags.DEFINE_integer(
        name='version', short_name='vn', default=5,
        help=flags_core.help_wrap('The version number of a model.'))

    flags.DEFINE_integer(
        name='best_epoch', short_name='be', default=50,
        help=flags_core.help_wrap('The best epoch number.'))

    flags.DEFINE_integer(
        name='gpu_num', short_name='gn', default=0,
        help=flags_core.help_wrap('The gpu number.'))

    flags.DEFINE_integer(
        name='train_steps', short_name='ts', default=100000,
    ...
    flags.DEFINE_boolean(
        name='enable_time_history', default=False,
    ...
    flags.DEFINE_integer(
        name='max_length', short_name='ml', default=150,
        help=flags_core.help_wrap(
    ...
    # test_set
    flags.DEFINE_string(
        name='base_path', short_name='bp', default="../data",
        help=flags_core.help_wrap(
            'base path'))

    flags.DEFINE_string(
        name='test_name', short_name='tn', default="logp06",
        help=flags_core.help_wrap(
            'test name'))

    flags.DEFINE_string(
        name='trial', short_name='tr', default="a",
        help=flags_core.help_wrap(
            'test trial (a,b,c,d...)'))
    ...
    flags.DEFINE_string(
        name='bleu_source', short_name='bls', default="/data/transformer/data/newstest2014.en",
        help=flags_core.help_wrap(
            ...
            'uncased BLEU score.'))
    flags.DEFINE_string(
        name='bleu_ref', short_name='blr', default="/data/transformer/data/newstest2014.de",
        help=flags_core.help_wrap(
            'Path to source file containing text translate when calculating the '
            'official BLEU score. Both --bleu_source and --bleu_ref must be set. '
            'Use the flag --stop_threshold to stop the script based on the '
            'uncased BLEU score.'))
    flags.DEFINE_string(
        name='vocab_file', short_name='vf', default="/data/transformer/data/vocab.ende.32768",
        help=flags_core.help_wrap(
    ...
    flags_core.set_defaults(data_dir="/data/transformer/data",
                            model_dir="/data/transformer/model_big",
                            batch_size=4096,
                            train_epochs=10)
