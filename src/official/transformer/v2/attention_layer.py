...
class Attention(tf.keras.layers.Layer):
    ...
    def __init__(self, hidden_size, num_heads, attention_dropout, use_bias=False):
    ...
    def build(self, input_shape):
        ...
        self.q_dense_layer = tf.keras.layers.Dense(
            self.hidden_size, use_bias=self.use_bias, name="q")
        self.k_dense_layer = tf.keras.layers.Dense(
            self.hidden_size, use_bias=self.use_bias, name="k")
        self.v_dense_layer = tf.keras.layers.Dense(
            self.hidden_size, use_bias=self.use_bias, name="v")
        self.output_dense_layer = tf.keras.layers.Dense(
            self.hidden_size, use_bias=self.use_bias, name="output_transform")
